...
from inicio.views import inicio,camaras,crear_camara,eliminar_camara,about_me,tripodes,crear_tripode,microfonos,crear_microfono
...
urlpatterns = [
    ...
    # path('camaras/<int:camara_id>/actualizar/', actualizar_camara, name='actualizar_camara'),
